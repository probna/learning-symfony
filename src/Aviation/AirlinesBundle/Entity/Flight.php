...
class Flight
{
     ...
     *
     * @ORM\JoinColumn(name="departureAirport", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
     ...
     * @ORM\ManyToOne(targetEntity="Aviation\AirlinesBundle\Entity\Airport")
     *
     * @ORM\JoinColumn(name="arrivalAirport", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
     ...
     *
     * @ORM\JoinColumn(name="airline", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
    private $airline;
